                ...
                <ul class="sidebar-menu scrollable pos-r">
                    <li class="nav-item mT-30 actived">
                        <a class="sidebar-link" href="{{route('admin.dashboard')}}"><span class="icon-holder"><i
                                    class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i
                                ...
                                class="title">Property Listings</span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="sidebar-link" href="datatable.html">Listings Tour Requests</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="page-container">
            ...
            <div class="header navbar">
                <div class="header-container">
                    <ul class="nav-left">
                        <li>
                            <a id="sidebar-toggle" class="sidebar-toggle" href="javascript:void(0);"><i
                                    class="ti-menu"></i></a>
                        </li>
                        <li class="search-box">
                    ...
                    <ul class="nav-right">
                        <li class="notifications dropdown">
                            ...
                            <a href="" class="dropdown-toggle no-after" id="dropdownMenuButton1"
                                data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-bell"></i></a>
                        ...
                        <li class="notifications dropdown">
                            ...
                            <a href="" class="dropdown-toggle no-after" data-bs-toggle="dropdown"><i
                                    class="ti-email"></i></a>
                            <ul class="dropdown-menu">
                                <li class="pX-20 pY-15 bdB">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu fsz-sm">
                                <li>
                                    <a href="" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i
                                ...
                                <li>
                                    <a href="email.html" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i
